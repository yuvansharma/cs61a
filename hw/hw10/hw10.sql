...
CREATE TABLE sentences AS
  SELECT "The two siblings, "|| sibling1 || " plus " || sibling2 || " have the same size: " || a.size from siblings, size_of_dogs as a, size_of_dogs as b where a.name = sibling1 and b.name = sibling2 and a.size = b.size;
