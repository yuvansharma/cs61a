...
class Ant(Insect):
    ...
    def add_to(self, place):
        if place.ant is None:
            ...
            if place.ant.is_container: # ant already present is container
    ...
    def double(self):
        ...
        if not self.double_damage: # damage hasn't been doubled
            self.damage *= 2
...
class ThrowerAnt(Ant):
    ...
    def nearest_bee(self):
        ...
        # only generate ants between the lower and upper bound
        ...
        while not(temp.is_hive) and count <= self.upper_bound - self.lower_bound:
            if len(temp.bees) != 0:
...
# END Problem 12
    ...
    def construct(cls, gamestate):
       ...
       # if test_ant.name == 'Queen':
       #     print("here")
       # return test_ant if test_ant.name == 'Queen' else None
